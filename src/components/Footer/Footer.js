...
import './footer.css';
import gpay from '../../assets/img/icon/goo.png';
import apppay from '../../assets/img/icon/applepay.png';
import visa from '../../assets/img/visa.png';
import master from '../../assets/img/master.png';
import google from '../../assets/img/google-pay 1.png';
import paykeeper from '../../assets/img/paykeep.png';
import apple from '../../assets/img/apple.png';
import vk from '../../assets/img/icon/vk-social-logotype.svg'
import insta from '../../assets/img/icon/instagram.svg'
import youtube from '../../assets/img/icon/youtube.svg'
import subs from '../../assets/img/footer-icon/Vector.svg'
import eye from '../../assets/img/footer-icon/Group.svg'
import sitemap from '../../assets/img/footer-icon/site-map 1.svg'
